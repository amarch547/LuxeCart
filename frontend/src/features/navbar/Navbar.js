    ...
    <>
      {userInfo && (
        <div className="min-h-full">
          <Disclosure as="nav" className="bg-cyan-950 text-white">
            {({ open }) => (
              <>
                    ...
                    <div className="hidden md:block">
                      <div className="ml-4 flex items-center md:ml-6">
                        <Link to="/cart">
                          <button
                            type="button"
                            className="rounded-full p-1 text-cyan-400 hover:text-white"
                          >
                  ...
                  <div className="border-t border-gray-700 pb-3 pt-4">
                    <div className="flex items-center px-5">
                      ...
                      <Link to="/cart">
                        <button
                          type="button"
                          className="ml-auto flex-shrink-0 rounded-full p-1 text-gray-400 hover:text-white"
                        >
                          <ShoppingCartIcon
                            className="h-6 w-6"
                            aria-hidden="true"
