...
export default function Signup() {
  ...
  return (
    <>
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:w-full lg:px-8 xl:w-6/12 xl:ml-80 2xl:w-11/12">
        <div className="shadow-sm bg-white rounded-md py-8 px-2">
